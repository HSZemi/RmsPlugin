...
public class RmsPercentChanceCommandImpl extends ASTWrapperPsiElement implements RmsPercentChanceCommand {

  public RmsPercentChanceCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitPercentChanceCommand(this);
  }
