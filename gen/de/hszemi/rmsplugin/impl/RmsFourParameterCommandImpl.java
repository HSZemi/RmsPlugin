...
public class RmsFourParameterCommandImpl extends ASTWrapperPsiElement implements RmsFourParameterCommand {

  public RmsFourParameterCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitFourParameterCommand(this);
  }
