...
public class RmsHashmacroNameImpl extends ASTWrapperPsiElement implements RmsHashmacroName {

  public RmsHashmacroNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitHashmacroName(this);
  }
