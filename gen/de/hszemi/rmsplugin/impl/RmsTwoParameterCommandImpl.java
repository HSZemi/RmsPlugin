...
public class RmsTwoParameterCommandImpl extends ASTWrapperPsiElement implements RmsTwoParameterCommand {

  public RmsTwoParameterCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitTwoParameterCommand(this);
  }
