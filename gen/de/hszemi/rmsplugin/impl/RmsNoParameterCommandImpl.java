...
public class RmsNoParameterCommandImpl extends ASTWrapperPsiElement implements RmsNoParameterCommand {

  public RmsNoParameterCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitNoParameterCommand(this);
  }
