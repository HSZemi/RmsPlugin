...
public class RmsHashmacroImpl extends ASTWrapperPsiElement implements RmsHashmacro {

  public RmsHashmacroImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RmsVisitor visitor) {
    visitor.visitHashmacro(this);
  }
  ...
  @Override
  @Nullable
  public RmsHashmacroName getHashmacroName() {
    return findChildByClass(RmsHashmacroName.class);
  }
