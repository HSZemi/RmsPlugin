...
public class RmsIfBlockImpl extends ASTWrapperPsiElement implements RmsIfBlock {

  public RmsIfBlockImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RmsBlockContent> getBlockContentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RmsBlockContent.class);
  }
